...
export const Hero = () => {
  ...
  return (
    <div
      className="px-4 sm:px-32 relative inline-flex flex-col w-full
    ...
    >
      ...
      <div className="flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs">
        ...
        hover:scale-102 active:scale-95 transition courser-pointer"
          onClick={() => navigate("/ai")}
        >
          Start creating now
        </button>
      ...
      <div data-aos="fade-up" className="flex items-center gap-2 mt-8 mx-auto text-gray-600">
        <img src={assets.user_group} alt="" className="h-8" /> Trusted by 50k People
      </div>
    </div>
  );
};
